...
DEFAULTS: dict[str, Any] = {
    ...
    "group": {
        ...
        "keep_going_window_sec": 60,
        "keep_going_max": 1,
        "keep_going_allow_tools": False,
        "keep_going_ack_words": [
            "嗯",
            "嗯嗯",
            "好",
            "好的",
    ...
    "tools": {
        ...
        "denylist": [
            "web_search_tavily",
            "web_search_bocha",
            # qqadmin：仅放行 ban/whole_ban/card/title；其余 LLM 工具默认隐藏
            "llm_set_group_kick",
            "llm_set_group_block",
            "llm_set_essence_msg",
...
FLAT_KEY_PATHS: dict[str, tuple[str, ...]] = {
    ...
    "续聊窗口秒": ("group", "keep_going_window_sec"),
    "续聊上限": ("group", "keep_going_max"),
    "续聊允许工具": ("group", "keep_going_allow_tools"),
    ...
    "戳一戳入站冷却秒": ("poke", "incoming_cooldown_sec"),
    "戳一戳反戳最大次数": ("poke", "antipoke_max_times"),
    ...
    "group_keep_going_window_sec": ("group", "keep_going_window_sec"),
    "group_keep_going_max": ("group", "keep_going_max"),
    "group_keep_going_allow_tools": ("group", "keep_going_allow_tools"),
...
FLAT_LIST_KEYS: dict[str, tuple[str, ...]] = {
    "休息关键词": ("rest", "keywords"),
    "续聊确认词": ("group", "keep_going_ack_words"),
